Source :
[HTB Academy](https://academy.hackthebox.com/app/module/112/section/1073)
...
***Port used for IMAP: 143 alternatively 993 for encrypted***
IMAP works unencrypted and transmits commands, emails, or usernames and passwords in plain text

---
## Default Configuration & Dangerous Settings
Check [HTB Academy](https://academy.hackthebox.com/app/module/112/section/1073) for information about settings configurations & Commands.
Also about Dangerous setting that is missconfigured.
...
> ```shell
> nusss@htb[/htb]$ sudo nmap 10.129.14.128 -sV -p110,143,993,995 -sC
> 
...
> [!example]- Curl Login with Valid Credential
> ```shell
> nusss@htb[/htb]$ curl -k 'imaps://10.129.14.128' --user user:p4ssw0rd
> 
...
> [!example]- Detailed Enumeration with Curl
> ```shell
> nusss@htb[/htb]$ curl -k 'imaps://10.129.14.128' --user cry0l1t3:1234 -v
> 
...
> [!example]- OpenSSL - TLS Encrypted Interaction POP3
> ```shell
> nusss@htb[/htb]$ openssl s_client -connect 10.129.14.128:pop3s
> 
> CONNECTED(00000003)
...
> [!example]- OpenSSL - TLS Encrypted Interaction IMAP
> ```shell
> nusss@htb[/htb]$ openssl s_client -connect 10.129.14.128:imaps
> 
> CONNECTED(00000003)
> Can't use SSL_get_servername
> depth=0 C = US, ST = California, L = Sacramento, O = Inlanefreight, OU = Customer Support, CN = mail1.inlanefreight.htb, emailAddress = cry0l1t3@inlanefreight.htb
